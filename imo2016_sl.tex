...
There are intuitively true, and it's not difficult for us to arrive at the answer (or rather, conjecture) of $n-2$. The difficult part is to make the proof rigorous---and writing down. 
...
Denote $F$ as above (the midpoint of $AH$), $X_H$ as the foot of perpendicular from $C$ to $AB$, and $Y_H$ the foor of perpendicular from $B$ to $AC$. 
